...
<body style="background-image:url(assets/images/bg2.jpg);background-size:cover;">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <form action="<?=$_SERVER['REQUEST_URI']?>" method="POST">
                    <div class="panel panel-dark login-box">
                        <div class="panel-heading"><h3 class="text-center">SPK Pemilihan Karyawan Terbaik</h3></div>
                        ...
                        <div class="panel-footer">
                            ...
                            <br>
                            <p class="text-center">Pangkas Rambut Pratama</p>
                        </div>
                    </div>
                </form>
            </div>
