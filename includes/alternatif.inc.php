...
class Alternatif {
	...
	function insert() {
		...
		$stmt->bindParam(3, $this->tempat_lahir);
		$stmt->bindParam(4, $this->tanggal_lahir);
		$stmt->bindParam(5, $this->kelamin);
		$stmt->bindParam(6, $this->alamat);
		$stmt->bindParam(7, $this->tanggal_masuk);
		$stmt->bindParam(8, $this->pendidikan);
